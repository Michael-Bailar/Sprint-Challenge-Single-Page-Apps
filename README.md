...
> Answer: Client-side-routing is great because a the user's experience is more fluid. It lowers loading times (except initially) and streamlines the site. 
...
- [x]  Fetch a list of characters from the Rick and Morty API's Characters endpoint *`https://cors-anywhere.herokuapp.com/https://rickandmortyapi.com/api/character/`* and render them to the screen. 

new link? https://cors-anywhere.herokuapp.com/https://rickandmortyapi.com/api/character/

_NOTE: https://cors-anywhere.herokuapp.com/ in front of the actual URL just let's us get around CORS errors that happen on the server._
